...
class Documento(object):
    ...
    def orgao_expedidor(self, orgao_expedidor):
        ...
        allowed_values = ["IFP", "DETRAN", "Cons. Reg. de Administração", "Cons. Reg. de Biblioteconomia", "Cons. Reg. de Biologia", "Cons. Reg. de Contabilidade", "Cons. Reg. de Corretor Imóveis", "Cons. Reg. de Economia", "Cons. Reg. de Enfermagem", "Cons. Reg. de Engenharia", "Cons. Reg. de Farmácia", "Cons. Reg. de Fisioterapia", "Cons. Reg. de Fonoaudiologia", "Cons. Reg. de Medicina", "Cons. Reg. de Veterinária", "Cons. Reg. de Nutricionista", "Cons. Reg. de Odontologia", "Cons. Reg. de Psicologia", "Cons. Reg. de Química", "Cons. Reg. de Serv. Social", "Dpto. Polícia Federal", "Ministério da Aeronáutica", "Ministério da Marinha", "Ministério do Exército", "OAB", "Outros Expedidores", "SSP"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and orgao_expedidor not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid value for `orgao_expedidor` ({0}), must be one of {1}"  # noqa: E501
                .format(orgao_expedidor, allowed_values)
            )
