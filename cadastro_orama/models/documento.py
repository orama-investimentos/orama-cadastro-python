...
class Documento(object):
    ...
    def __init__(self, tipo_documento=None, numero_documento=None, orgao_expedidor=None, uf_emissao=None, data_emissao=None, data_validade=None, codigo_seguranca_cnh=None):  # noqa: E501
        ...
        if orgao_expedidor is not None:
            self.orgao_expedidor = orgao_expedidor
        if uf_emissao is not None:
    ...
    def tipo_documento(self, tipo_documento):
        ...
        if tipo_documento not in allowed_values:
            raise ValueError(
    ...
    def numero_documento(self, numero_documento):
        ...
        :type: str
        """
        if numero_documento is not None and len(numero_documento) > 50:
    ...
    def orgao_expedidor(self, orgao_expedidor):
        ...
        :type: str
        """
        if orgao_expedidor is not None and len(orgao_expedidor) > 30:
