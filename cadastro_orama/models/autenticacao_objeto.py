...
class AutenticacaoObjeto(object):
    ...
    @property
    def token(self):
        """Gets the token of this AutenticacaoObjeto.  # noqa: E501


        :return: The token of this AutenticacaoObjeto.  # noqa: E501
        :rtype: str
        """
        return self._token
    ...
    def token(self, token):
        """Sets the token of this AutenticacaoObjeto.


        :param token: The token of this AutenticacaoObjeto.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AutenticacaoObjeto):
            return False
