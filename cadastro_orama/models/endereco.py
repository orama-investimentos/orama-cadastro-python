...
class Endereco(object):
    ...
    def logradouro(self, logradouro):
        ...
        if (self.local_vars_configuration.client_side_validation and
                logradouro is not None and len(logradouro) > 200):
    ...
    def bairro(self, bairro):
        ...
        if (self.local_vars_configuration.client_side_validation and
                bairro is not None and len(bairro) > 30):
    ...
    def uf(self, uf):
        ...
        if self.local_vars_configuration.client_side_validation and uf not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid value for `uf` ({0}), must be one of {1}"  # noqa: E501
                .format(uf, allowed_values)
            )
    ...
    def cidade(self, cidade):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and cidade is None:  # noqa: E501
            raise ValueError("Invalid value for `cidade`, must not be `None`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                cidade is not None and len(cidade) > 200):
    ...
    def numero(self, numero):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                numero is not None and len(numero) > 10):
    ...
    def complemento(self, complemento):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                complemento is not None and len(complemento) > 50):
