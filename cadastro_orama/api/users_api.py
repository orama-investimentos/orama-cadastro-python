...
class UsersApi(object):
    ...
    def account_perfil_assinatura_eletronica_get(self, cpf, **kwargs):  # noqa: E501
        """Verifica se a assinatura eletronica já foi definida.  # noqa: E501

        Verifica se a assinatura eletronica já foi definida.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.account_perfil_assinatura_eletronica_get(cpf, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.account_perfil_assinatura_eletronica_get_with_http_info(cpf, **kwargs)  # noqa: E501

    def account_perfil_assinatura_eletronica_get_with_http_info(self, cpf, **kwargs):  # noqa: E501
        """Verifica se a assinatura eletronica já foi definida.  # noqa: E501

        Verifica se a assinatura eletronica já foi definida.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.account_perfil_assinatura_eletronica_get_with_http_info(cpf, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method account_perfil_assinatura_eletronica_get" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'cpf' is set
        if self.api_client.client_side_validation and ('cpf' not in local_var_params or  # noqa: E501
                                                        local_var_params['cpf'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `cpf` when calling `account_perfil_assinatura_eletronica_get`")  # noqa: E501
        ...
        body_params = None
        # Authentication setting
        auth_settings = ['Api-Key', 'JWT']  # noqa: E501

        return self.api_client.call_api(
            '/perfil/{cpf}/assinatura-eletronica/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def account_perfil_assinatura_eletronica_post(self, cpf, assinatura_eletronica, **kwargs):  # noqa: E501
        """Realiza o cadastro da assinatura eletrônica do perfil.  # noqa: E501

        Cadastra a assinatura eletrônica do perfil, realiza validação da assinatura eletronica.  A assinatura deve respeitar as seguintes condições: - Conter de 6 a 15 dígitos - Conter apenas letras e números - Não deve conter 6 ou mais dígitos sequênciais, ex.: 'abcdef', '123456' - Se a assinatura contém entre 6 e 7 dígitos não deve repetir 3 dígitos seguidos, ex.: '111', 'aaa' - Se a assinatura contém entre 8 e 12 dígitos não deve repetir 4 dígitos seguidos, ex.: '1111', 'aaaa' - Se a assinatura contém entre 13 e 14 dígitos não deve repetir 5 dígitos seguidos, ex.: '11111', 'aaaaa' - Se a assinatura contém 15 dígitos não deve repetir 6 dígitos seguidos, ex.: '111111', 'aaaaaa' - A assinatura não deve conter nenhuma das palavras a seguir:      'select', 'update', 'insert', 'delete', 'drop', 'truncate', 'waitfor', 'delay', 'where', 'from', 'having', 'script', 'applet', 'sha1'  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.account_perfil_assinatura_eletronica_post(cpf, assinatura_eletronica, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str cpf: CPF do perfil (required)
        :param AssinaturaEletronica assinatura_eletronica: Dados para criação da assinatura eletrônica (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.account_perfil_assinatura_eletronica_post_with_http_info(cpf, assinatura_eletronica, **kwargs)  # noqa: E501

    def account_perfil_assinatura_eletronica_post_with_http_info(self, cpf, assinatura_eletronica, **kwargs):  # noqa: E501
        """Realiza o cadastro da assinatura eletrônica do perfil.  # noqa: E501

        Cadastra a assinatura eletrônica do perfil, realiza validação da assinatura eletronica.  A assinatura deve respeitar as seguintes condições: - Conter de 6 a 15 dígitos - Conter apenas letras e números - Não deve conter 6 ou mais dígitos sequênciais, ex.: 'abcdef', '123456' - Se a assinatura contém entre 6 e 7 dígitos não deve repetir 3 dígitos seguidos, ex.: '111', 'aaa' - Se a assinatura contém entre 8 e 12 dígitos não deve repetir 4 dígitos seguidos, ex.: '1111', 'aaaa' - Se a assinatura contém entre 13 e 14 dígitos não deve repetir 5 dígitos seguidos, ex.: '11111', 'aaaaa' - Se a assinatura contém 15 dígitos não deve repetir 6 dígitos seguidos, ex.: '111111', 'aaaaaa' - A assinatura não deve conter nenhuma das palavras a seguir:      'select', 'update', 'insert', 'delete', 'drop', 'truncate', 'waitfor', 'delay', 'where', 'from', 'having', 'script', 'applet', 'sha1'  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.account_perfil_assinatura_eletronica_post_with_http_info(cpf, assinatura_eletronica, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['cpf', 'assinatura_eletronica']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method account_perfil_assinatura_eletronica_post" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'cpf' is set
        if self.api_client.client_side_validation and ('cpf' not in local_var_params or  # noqa: E501
                                                        local_var_params['cpf'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `cpf` when calling `account_perfil_assinatura_eletronica_post`")  # noqa: E501
        # verify the required parameter 'assinatura_eletronica' is set
        if self.api_client.client_side_validation and ('assinatura_eletronica' not in local_var_params or  # noqa: E501
                                                        local_var_params['assinatura_eletronica'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `assinatura_eletronica` when calling `account_perfil_assinatura_eletronica_post`")  # noqa: E501
        ...
        body_params = None
        if 'assinatura_eletronica' in local_var_params:
            body_params = local_var_params['assinatura_eletronica']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            '/perfil/{cpf}/assinatura-eletronica/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def account_perfil_termos_confirmacao_get(self, cpf, **kwargs):  # noqa: E501
        """Estado atual de confirmação do aceite de termos  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.account_perfil_termos_confirmacao_get(cpf, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.account_perfil_termos_confirmacao_get_with_http_info(cpf, **kwargs)  # noqa: E501

    def account_perfil_termos_confirmacao_get_with_http_info(self, cpf, **kwargs):  # noqa: E501
        """Estado atual de confirmação do aceite de termos  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.account_perfil_termos_confirmacao_get_with_http_info(cpf, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method account_perfil_termos_confirmacao_get" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'cpf' is set
        if self.api_client.client_side_validation and ('cpf' not in local_var_params or  # noqa: E501
                                                        local_var_params['cpf'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `cpf` when calling `account_perfil_termos_confirmacao_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/perfil/{cpf}/termos/confirmacao/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def account_perfil_termos_confirmacao_post(self, cpf, **kwargs):  # noqa: E501
        """Confirma o aceite de termos  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.account_perfil_termos_confirmacao_post(cpf, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.account_perfil_termos_confirmacao_post_with_http_info(cpf, **kwargs)  # noqa: E501

    def account_perfil_termos_confirmacao_post_with_http_info(self, cpf, **kwargs):  # noqa: E501
        """Confirma o aceite de termos  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.account_perfil_termos_confirmacao_post_with_http_info(cpf, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method account_perfil_termos_confirmacao_post" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'cpf' is set
        if self.api_client.client_side_validation and ('cpf' not in local_var_params or  # noqa: E501
                                                        local_var_params['cpf'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `cpf` when calling `account_perfil_termos_confirmacao_post`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/perfil/{cpf}/termos/confirmacao/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def account_perfil_termos_get(self, cpf, **kwargs):  # noqa: E501
        """Consulta os termos requeridos para o perfil  # noqa: E501

        Consulta os termos exigidos para o perfil  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.account_perfil_termos_get(cpf, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.account_perfil_termos_get_with_http_info(cpf, **kwargs)  # noqa: E501

    def account_perfil_termos_get_with_http_info(self, cpf, **kwargs):  # noqa: E501
        """Consulta os termos requeridos para o perfil  # noqa: E501

        Consulta os termos exigidos para o perfil  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.account_perfil_termos_get_with_http_info(cpf, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(list[Termos], status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method account_perfil_termos_get" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'cpf' is set
        if self.api_client.client_side_validation and ('cpf' not in local_var_params or  # noqa: E501
                                                        local_var_params['cpf'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `cpf` when calling `account_perfil_termos_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[Termos]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
